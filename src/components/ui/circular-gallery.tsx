  ...
  (
    ...
    useEffect(() => {
      const handleScroll = () => {
        ...
        // Make rotation complete 2 full rotations through scroll
    ...
    return (
      <div
        ref={ref}
        role="region"
        aria-label="Circular 3D Portfolio Gallery"
        className={cn(
                ...
                <div className="relative w-full h-full rounded-lg shadow-2xl overflow-hidden group border border-border bg-card/70 dark:bg-card/30 backdrop-blur-lg">
                  {item.media.type === "video" ? (
                    <video
                      ...
                      style={{ objectPosition: item.media.pos || "center" }}
                      autoPlay
                      loop
                      muted
                      playsInline
