...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.daniekeysstudios.com/legal/terms-of-service",
  },
  // Stub content — keep out of the index until real, reviewed terms replace
  // the placeholders below. Flip to index:true at launch.
        ...
        <section className="relative overflow-hidden bg-primary pb-space-9 pt-24 lg:pb-space-10 lg:pt-32">
          ...
          <div className="relative z-10 mx-auto max-w-[1280px] px-space-4 md:px-space-6">
            ...
            <p className="mt-space-5 max-w-2xl text-ds-body-lg text-light-dark">
              The terms that govern use of the Daniekeys Studios website and the
