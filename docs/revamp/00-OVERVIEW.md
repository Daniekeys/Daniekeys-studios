...
- **Founder credit / byline name** for the hero "Founded by…" line and the About page's founder quote. Real name not present in the fetched site content — likely Daniel Ayeni, but confirm before shipping a name publicly.
- **Company history/timeline milestones** (year-by-year story) for the About page — the real site confirms "5+ years in business" but no published year-by-year narrative was found. A 4–5 entry timeline structure is specced; confirm actual years/milestones before launch.
